    ...
    if(formAno.value.length == 0 || Number(formAno.value) > ano || Number(formAno.value) < anoMax) {
        ...
        if(fsex[0].checked) {
            ...
            if(idade >= 0 && idade <= 10) {
                ...
                if(idade >= 0 && idade < 10){
                    // criança
                    img.setAttribute("src", "imgAnime/madoka.png")
                    ...
                    // jovem
                    img.setAttribute("src", "imgAnime/kimetsu.png")
                    ...
                    // Adulto
                    img.setAttribute("src", "imgAnime/sniper.png")
                    ...
                    // Adulto
                    img.setAttribute("src", "imgAnime/kakegurui.png")
                    ...
                    // idoso
                    img.setAttribute("src", "imgAnime/atk.png")
                ...
                if(idade >= 0 && idade < 10){
                // criança
                img.setAttribute("src", "imgAnime/ponyo.png")
                ...
                // jovem
                img.setAttribute("src", "imgAnime/your.png")
                ...
                // Adulto
                img.setAttribute("src", "imgAnime/vagalume.png")
                ...
                // Adulto
                img.setAttribute("src", "imgAnime/garden.png")
                ...
                // idoso
                img.setAttribute("src", "imgAnime/made.png")
